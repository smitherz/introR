...
{% highlight text %}
##    a b     c           d
## 1  1 a  TRUE -0.80351195
## 2  2 b  TRUE -1.84061521
## 3  3 c FALSE -1.67299866
## 4 10 x FALSE -0.05125711
## 5 11 y FALSE -0.03870654
## 6 12 z FALSE  0.36246291
{% endhighlight %}
...
{% highlight text %}
##    a b     c           d          x names
## 1  1 a  TRUE -0.80351195 -0.1179165   bob
## 2  3 c FALSE -1.67299866  0.3209963   joe
## 3 10 x FALSE -0.05125711  1.7253893   sue
## 4 11 y FALSE -0.03870654 -0.7547471  <NA>
{% endhighlight %}
...
##    a b     c           d          x names
## 1  1 a  TRUE -0.80351195 -0.1179165   bob
## 2  2 b  TRUE -1.84061521         NA  <NA>
## 3  3 c FALSE -1.67299866  0.3209963   joe
## 4 10 x FALSE -0.05125711  1.7253893   sue
## 5 11 y FALSE -0.03870654 -0.7547471  <NA>
## 6 12 z FALSE  0.36246291         NA  <NA>
{% endhighlight %}
...
## 1  1 20.23507 22.28473 23.15679 19.71287
## 2  2 24.31704 19.36893 18.69022 20.32899
## 3  3 20.55350 22.05028 24.28050 19.20394
## 4  4 22.83607 19.40236 19.80708 22.15868
## 5  5 20.28234 21.11405 18.20205 18.78702
## 6  6 22.94332 21.07944 24.31922 21.98894
{% endhighlight %}
...
## 1  1 20.23507 22.28473 23.15679 19.71287  21.34737
## 2  2 24.31704 19.36893 18.69022 20.32899  20.67630
## 3  3 20.55350 22.05028 24.28050 19.20394  21.52206
## 4  4 22.83607 19.40236 19.80708 22.15868  21.05105
## 5  5 20.28234 21.11405 18.20205 18.78702  19.59636
## 6  6 22.94332 21.07944 24.31922 21.98894  22.58273
{% endhighlight %}
...
##Exercise 3
Add a new section to our script to calculate the gages landcover means. 

1. Use `gages_data` that we created in the previous exercise.
2. Add some lines to your script to calculate the mean by COUNTYNAME_SITE, for DEVNLCD06, FORESTNLCD06, BARRENNLCD06, PASTURENLCD06, and CROPSNLCD06. Save to a data frame named   `gages_cover_means`.
3. It might be interesting to compare the grouped means to the means of each value for the entire dataset.  Using `summarize()`, calculate the mean coverage for the state (hint: no groups!).  Save this as `gages_cover_all_means`.
4. We removed some of the landcover types when we originally subset the data at the beginning of the exercise. Create a table called `gages_cover_total` to see what the total percent coverage is of the landcover types we selected (note: it is probably not 100%). Hint: think `transmute()`.
5. Bonus: Figure out which landcover type we are missing for Harding county
6. Double Bonus: Do #2 above across the whole U.S.
